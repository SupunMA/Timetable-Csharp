...
{
    public partial class SumaliEditWorkingDaysHours : UserControl
    {
        ...
        SqlDataReader dr;
        public SumaliEditWorkingDaysHours()
        {
            InitializeComponent();
        }
        ...
        private void UpDownWorkingHours_ValueChanged(object sender, EventArgs e)
        {
